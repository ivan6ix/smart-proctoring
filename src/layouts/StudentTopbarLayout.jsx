...
function StudentTopbarLayout({ children }) {
    ...
    <div className="min-h-screen bg-gray-100">
          ...
          <div className="flex items-center gap-3 relative">
            <div className="relative">
              <button
                ...
                className="bg-white border border-gray-200 rounded-2xl p-3 shadow-sm hover:bg-gray-100 transition"
              >
                ...
                <div className="absolute right-0 mt-3 w-96 bg-white rounded-3xl shadow-xl border border-gray-100 z-50 p-5">
                  ...
                  <div className="space-y-3">
                    <div className="bg-gray-50 rounded-2xl p-4">
                      ...
                      <p className="text-sm text-gray-500">
                        Posted tasks and exams will appear here.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="relative">
              ...
              {showProfileMenu && (
                <div className="absolute right-0 mt-3 w-72 bg-white rounded-3xl shadow-xl border border-gray-100 z-50 p-3">
                  <button
                    onClick={() => {
      ...
      {showNewMessageModal && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 px-4">
          <div className="bg-white rounded-3xl shadow-xl w-full max-w-2xl p-7">
            ...
            <form onSubmit={handleSendMessage} className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                <label className="border border-gray-200 rounded-2xl p-4 hover:bg-gray-50 cursor-pointer flex items-center gap-3">
                ...
                <button
                  type="button"
                  className="border border-gray-200 rounded-2xl p-4 hover:bg-gray-50 flex items-center gap-3"
                >
          ...
          <div className="bg-white rounded-3xl shadow-xl w-full max-w-lg p-7">
            ...
            <form onSubmit={handleSaveProfile} className="space-y-4">
              <input
                ...
                className="w-full border rounded-2xl px-4 py-3 bg-gray-100 text-gray-500 cursor-not-allowed"
              />
              ...
              <div className="flex justify-end gap-3 pt-4">
                ...
                <button
                  type="submit"
                  className="px-5 py-3 rounded-2xl font-semibold bg-blue-600 hover:bg-blue-700 text-white"
                >
                  Save Changes
                </button>
              </div>
          ...
          <div className="bg-white rounded-3xl shadow-xl w-full max-w-md p-7">
            ...
            <form onSubmit={handleChangePassword} className="space-y-4">
              ...
              <div className="flex justify-end gap-3 pt-2">
                ...
                <button className="px-5 py-3 rounded-2xl font-semibold bg-blue-600 hover:bg-blue-700 text-white">
                  Update Password
                </button>
              </div>
            </form>
          ...
          <div className="bg-white rounded-3xl shadow-xl w-full max-w-lg p-7">
            ...
            <div className="space-y-4">
              <div className="bg-gray-50 rounded-2xl p-5 border border-gray-100">
                ...
                <span className="inline-block mt-3 bg-green-100 text-green-700 px-3 py-1 rounded-xl text-sm font-semibold">
                  Active
                </span>
              </div>
...
export default StudentTopbarLayout;