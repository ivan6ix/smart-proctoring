...
function ProfessorTopbarLayout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      <div className="sticky top-0 z-40 h-[80px] bg-white/90 backdrop-blur border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-full flex items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-gray-500">Professor Portal</p>
          </div>
          ...
          <div className="flex items-center gap-3 relative">
            ...
            <div className="relative">
              ...
              {showNotifications && (
                <div className="absolute right-0 mt-3 w-80 bg-white rounded-3xl shadow-xl border border-gray-100 z-50 p-5">
                  ...
                  <div className="bg-gray-50 rounded-2xl p-4">
                    ...
                    <p className="text-sm text-gray-500">
                      Exam alerts and submissions will appear here.
                    </p>
                  </div>
                </div>
              )}
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 px-4">
          <div className="bg-white rounded-3xl shadow-xl w-full max-w-lg p-7">
            <div className="flex items-center justify-between mb-5">
              ...
              <button onClick={() => setShowProfileSettingsModal(false)}>
          ...
          <div className="bg-white rounded-3xl shadow-xl w-full max-w-lg p-7">
            ...
            <div className="space-y-4">
              <button
                ...
                className="w-full bg-gray-50 hover:bg-gray-100 rounded-2xl p-5 flex items-center justify-between"
              >
      ...
      {showDeviceSessionsModal && (
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 px-4">
          <div className="bg-white rounded-3xl shadow-xl w-full max-w-lg p-7">
            <h3 className="text-xl font-bold mb-5">Device Sessions</h3>

            <div className="bg-gray-50 rounded-2xl p-5 border mb-4">
...
export default ProfessorTopbarLayout;