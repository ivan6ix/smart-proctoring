...
function AdminTopbarLayout({ children }) {
  ...
  const sendMessage = async (e) => {
    ...
    setSelectedConversationUserId(receiverId);
    setReceiverId("");
    setSubject("");
    setMessageText("");
      ...
      <div className="sticky top-0 z-40 h-[80px] bg-white/90 backdrop-blur border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-full flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3 relative">
            ...
            {showMessages && (
              <div className="absolute right-20 top-14 w-96 bg-white rounded-3xl shadow-xl border border-gray-100 z-50 p-5">
            ...
            {showNotifications && (
              <div className="absolute right-12 top-14 w-96 bg-white rounded-3xl shadow-xl border border-gray-100 z-50 p-5">
        ...
        <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50 px-4">
          <div className="bg-white rounded-3xl shadow-xl w-full max-w-xl p-7">
            ...
            <form onSubmit={sendMessage} className="space-y-4">
              ...
              <button className="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 rounded-2xl font-semibold flex items-center justify-center gap-2">
                <Send className="w-5 h-5" />
                Send Message
              </button>
            </form>
